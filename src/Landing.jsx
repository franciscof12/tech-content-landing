...
function Landing() {
  return (
    <div className="w-screen h-screen text-white bg-cover bg-center"  style={{
      ...
      <img className="lg:w-1/12 md:w-3/12 w-5/12 mb-10 object-cover object-center" alt="hero" src={hero} />
